...
1. For checking hotspots in facebook dataset:

python3 dicenod_facebook.py

2. For checking hotspots in gnutella dataset:

python3 dicenod_gnutella.py 


CONTENTS:
---------
1. lasso.py: Utility to use cvxpy for solving the lasso problem
